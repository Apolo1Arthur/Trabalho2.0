...
<script>
  ...
  const textos = [
   ...
   `Com apenas 19 anos, Oprah começou sua carreira na televisão local, onde sua empatia e carisma conquistaram o público e abriram portas para grandes oportunidades.`
  },
    , 'Capítulo 3: Os primeiros passos na televisão e o talento nato...'
   `Ao apresentar seu próprio programa, Oprah revolucionou a TV americana, conectando-se profundamente com os telespectadores e tratando de temas importantes para a sociedade.`
  },
    , 'Capítulo 4: O sucesso estrondoso de seu talk show e o impacto na cultura...'
   `Além da televisão, Oprah expandiu seus negócios para editoras, rádio e cinema, tornando-se uma das mulheres mais influentes do mundo.`
  },
    , 'Capítulo 5: Envolvimento em causas sociais e empoderamento feminino...'
   `O legado de Oprah vai além do entretenimento, incluindo sua filantropia e o poder de inspirar milhões a acreditarem em si mesmos e lutarem por seus sonhos.`
  },
    , 'Capítulo 6: Legado de inspiração e transformação de vidas...'
   `Mesmo após décadas de sucesso, Oprah continua influenciando gerações, usando sua voz para promover mudanças sociais e incentivar o empoderamento pessoal.`
   }
  ];
...
const chapters = [
  {
    title: "Capítulo 1 - A Infância de Oprah",
    text: `Oprah Winfrey nasceu em uma família pobre no Mississippi, enfrentando adversidades desde cedo. Seu talento e determinação a impulsionaram a superar desafios e mudar seu destino.`
  },
  {
    title: "Capítulo 2 - O Início na Televisão",
    text: `Com apenas 19 anos, Oprah começou sua carreira na televisão local, onde sua empatia e carisma conquistaram o público e abriram portas para grandes oportunidades.`
  },
  {
    title: "Capítulo 3 - O Sucesso Nacional",
    text: `Ao apresentar seu próprio programa, Oprah revolucionou a TV americana, conectando-se profundamente com os telespectadores e tratando de temas importantes para a sociedade.`
  },
  {
    title: "Capítulo 4 - A Expansão do Império",
    text: `Além da televisão, Oprah expandiu seus negócios para editoras, rádio e cinema, tornando-se uma das mulheres mais influentes do mundo.`
  },
  {
    title: "Capítulo 5 - O Legado e Impacto",
    text: `O legado de Oprah vai além do entretenimento, incluindo sua filantropia e o poder de inspirar milhões a acreditarem em si mesmos e lutarem por seus sonhos.`
  },
  {
    title: "Capítulo 6 - A Influência Contínua",
    text: `Mesmo após décadas de sucesso, Oprah continua influenciando gerações, usando sua voz para promover mudanças sociais e incentivar o empoderamento pessoal.`
  }
];

const mysteriousPhrases = [
  "O som do desconhecido ecoa na tua mente.",
  "Você não sabe o que está buscando, mas está indo mesmo assim.",
  "Há uma espreita entre os pixels.",
  "Nem tudo que brilha é dado por luz.",
  "Eles sabem que você está aqui.",
  "Esse botão não devia ter sido apertado.",
  "Você sente frio, mas não está com frio."
];
